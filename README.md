...
|---|---|---|
| Universal | همه‌ی گوشی‌ها | [دانلود](https://github.com/Saj-1992/FastRay/releases/latest/download/Fastray_1.0.17_universal.apk) |
| arm64-v8a | گوشی‌های جدیدتر (۶۴ بیتی) - حجم کمتر | [دانلود](https://github.com/Saj-1992/FastRay/releases/latest/download/Fastray_1.0.17_arm64-v8a.apk) |
